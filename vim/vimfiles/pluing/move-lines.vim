...
nmap <unique> <C-k> <Plug>(move-line-up)
nmap <unique> <C-j> <Plug>(move-line-down)

vmap <unique> <C-k> <Plug>(move-multi-lines-up)
vmap <unique> <C-j> <Plug>(move-multi-lines-down)
